...
//    private String requestPath = "user/login.do";
//
//    @Test
//    public void test_userLogin_success() {
//        String reqUrl = TestConstant.REQ_PREFIX+requestPath;
//        List<NameValuePair> params = new ArrayList<NameValuePair>();
//        params.add(new BasicNameValuePair("user_name", "ceshi_user_name"));
//        params.add(new BasicNameValuePair("password", "ceshi_password"));
//        params.add(new BasicNameValuePair("verify_code", "ceshi_verify_code"));
