...
import com.mockuai.usercenter.mop.api.action.QueryConsigneeAction;
...
public class QueryConsigneeTest {
    ...
    @Test
    public void test_queryConsignee(){
        QueryConsigneeAction queryConsigneeAction =
                (QueryConsigneeAction) actionHolderMock.getAction("/user/consignee/list");
        RequestMock requestMock = new RequestMock();
        requestMock.setAttribute("user_id", 123L);
        MopResponse mopResponse = queryConsigneeAction.execute(requestMock);
