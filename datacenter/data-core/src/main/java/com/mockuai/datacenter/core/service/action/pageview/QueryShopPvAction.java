 ...
 */
@Service
public class QueryShopPvAction extends TransAction {

    private static final Logger log = LoggerFactory.getLogger(QueryShopPvAction.class);
    ...
    protected DataResponse doTransaction(RequestContext context) throws DataException {
        ...
        try {
            List<PageViewDTO> pvList = pageViewManager.queryShopPv(pageViewQTO);
    ...
    public String getName() {
        return ActionEnum.QUERY_SHOP_PV.getActionName();
    }
}
