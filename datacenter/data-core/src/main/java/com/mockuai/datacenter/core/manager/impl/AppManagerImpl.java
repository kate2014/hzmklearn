...
public class AppManagerImpl implements AppManager {
    ...
    public BizInfoDTO getBizInfo(String bizCode) throws DataException {
        if(StringUtils.isBlank(bizCode)){
            throw new DataException(ResponseCode.PARAM_E_INVALID, "bizCode is null");
        }
        ...
        try{
            ...
            throw new DataException(ResponseCode.SYS_E_SERVICE_EXCEPTION, e);
        }
    }
    ...
    public AppInfoDTO getAppInfo(String appKey) throws DataException {
        if(StringUtils.isBlank(appKey)){
            throw new DataException(ResponseCode.PARAM_E_INVALID, "appKey is null");
        }
