 ...
 */
@Service
public class QueryShopUvAction extends TransAction {

    private static final Logger log = LoggerFactory.getLogger(QueryShopUvAction.class);
    ...
    protected DataResponse doTransaction(RequestContext context) throws DataException {
        ...
        try {
            List<PageViewDTO> uvList = pageViewManager.queryShopUv(pageViewQTO);
            dataResponse = ResponseUtil.getSuccessResponse(uvList);
    ...
    public String getName() {
        return ActionEnum.QUERY_SHOP_UV.getActionName();
    }
}
