 ...
 */
@Service
public class QueryShopHourUvAction extends TransAction {

    private static final Logger log = LoggerFactory.getLogger(QueryShopHourUvAction.class);
    ...
    public String getName() {
        return ActionEnum.QUERY_SHOP_HOUR_UV.getActionName();
    }
}
