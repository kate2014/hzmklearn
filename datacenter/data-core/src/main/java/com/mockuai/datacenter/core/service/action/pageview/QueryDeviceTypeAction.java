 ...
 */
@Service
public class QueryDeviceTypeAction extends TransAction {

    private static final Logger log = LoggerFactory.getLogger(QueryDeviceTypeAction.class);
    ...
    public String getName() {
        return ActionEnum.QUERY_DEVICETYPE.getActionName();
    }
}
