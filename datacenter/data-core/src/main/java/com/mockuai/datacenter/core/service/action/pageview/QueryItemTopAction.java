 ...
 */
@Service
public class QueryItemTopAction extends TransAction {

    private static final Logger log = LoggerFactory.getLogger(QueryItemTopAction.class);
    ...
    public String getName() {
        return ActionEnum.QUERY_ITEMTOP.getActionName();
    }
}
