 ...
 */
@Service
public class AddItemInGroupAction implements Action {

    private static final Logger log = LoggerFactory.getLogger(AddItemInGroupAction.class);
    @Resource
    ...
    public ItemResponse execute(RequestContext context) throws ItemException {
        ...
        if(sellerId == null || itemId == null || groupId == null) {
        ...
        try {
            Boolean res = itemManager.updateItem(itemDTO);
    ...
    public String getName() {
        return ActionEnum.ADD_ITEM_GROUP_ACTION.getActionName();
    }
}
